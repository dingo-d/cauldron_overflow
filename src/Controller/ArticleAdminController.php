...
class ArticleAdminController extends AbstractController
{
  ...
  {
    $article = new Article();
    $article->setTitle('This is a title of the new article!')
      ->setSlug('this-is-a-title-of-the-new-article-' . rand(100, 999))
      ->setContent(<<<EOF
